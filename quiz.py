...
question = {
    ...
    "Who wrote the famous novel To Kill a Mockingbird?":['F. Scott Fitzgerald','Harper Lee','Jane Austen','J.K. Rowling'],
    "What is the chemical symbol for gold?":['Ag','Au','Hg','Pb'],
    "Which famous artist painted the ceiling of the Sistine Chapel?":['Leonardo da Vinci','Michelangelo','Raphael','Caravaggio'],
    "Which river is the longest in the world?":['Nile','Amazon','Yangtze','Mississippi'],
    "2+3": ['2', '3', '5', '9'],
    "2-1": ['2', '1', '5'],
    "3+3": ['3', '6', '9', '7'],
    "What is the highest mountain peak in the solar system?":['Mount Everest','Olympus Mons','Mount Kilimanjaro','Denali'],
    "What is capital of France?": ['Delhi','Tokyo','Paris','Berlin']
    
}
# define answer list
ans = ['Mars','Harper Lee','Au','Michelangelo','Nile','5', '1', '6','Olympus Mons','Italy']
